...
At it's core, HAN defines the [response](#response), [resource](#resource), & [transitions](#transitions).
The resource value can be a single object or a list of objects.
